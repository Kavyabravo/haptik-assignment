    ...
    <div style={{ display: "flex", justifyContent: "center" }}>
      <div className="mock-data-container drop-shadow curled">
        ...
        <ul>
          ...
          <li>
            On typing any string in the search bar, the search engine will try
            to first search for the name in the user list.
            <ul>
              <li>
              ...
              <li>
                On finding partially matched friend from userlist if user
                presses the key "ENTER", then the top element in the list on
                screen will be added to myfriendlist.
              </li>
              <li>
                And on finding no matched friend from the UserList if user
                presses "ENTER" key, the typed string will be added as new
                friend to the MyFriendList
              </li>
            </ul>
          </li>
          <li>
