  ...
  return (
    <div className="row friend-row">
      <div className="col-sm-6">
        ...
        <div className="user-request-status">is your friend</div>
      </div>
      <div className="col-sm-6">
        <span
          style={{ cursor: "pointer" }}
          className={`add-to-fav ${props.friend.isFav ? "fav" : "not-fav"}`}
          onClick={() => props.handleAddToFav(props.friend.id)}
        >
          ★
        </span>
        <span
          ...
          onClick={(e) => {
            if (
              window.confirm(
                `Are you sure you wish to remove ${props.friend.name} from your friend list?`
              )
            )
